...
<section id="section">
    <article class="Purchase Purchasefont">
        ...
        <div class="Purchasebg">
            ...
            @else
            <img src="{{asset('images/1.7.png')}}" alt="bg">
            @endif
        ...
        document.getElementById('selected_value').value = inputValue;
            ...
            function calculateTotal(totalId) {
                ...
                if (!isNaN(firstValue) && !isNaN(secondValue) && !isNaN(thirdValue)) {
                    var total = firstValue + secondValue + thirdValue + 100;
            ...
            function calculateTotal2(totalId) {
                ...
                if (!isNaN(fourthValue) && !isNaN(fifthValue) && !isNaN(sixthValue)) {
                    var total = fourthValue + fifthValue + sixthValue + 140;
            ...
            function calculateTotal3(totalId) {
                ...
                if (!isNaN(seventhValue) && !isNaN(eighthValue) && !isNaN(ninthValue)) {
                    var total = seventhValue + eighthValue + ninthValue + 200;
                    ...
                    <div class="cards">
                        ...
                        <div class="row">
                            ...
                            <div class="content_wrapper text-center">
                                ...
                                <button type="submit" class="btn button" onclick="MsetValueAndSubmit('200')"> PREMIUM <input type="text" readonly placeholder="200" class="transparent-input" name="mpamount" id="total6" value="">200$</button>
