...
<body>
                    ...
                    <ul class="nav-menus">
                            ...
                            <select class="form-control lang-change" name="lang">
                                ...
                                @if (count($languages) > 0)
                                    @foreach ($languages as $row)
                                        <option @if ($row->code == session()->get('lang_code')) selected @endif
                                            value="{{ $row->code }}"
                        ...
                        <li class="onhover-dropdown"><i data-feather="bell"></i><span class="dot"></span>
                            <ul class="notification-dropdown onhover-show-div">
                                <li>Notification <span class="badge rounded-pill badge-primary pull-right">3</span>
                                </li>
                                <li>
                                    <div class="media">
        ...
        <div class="page-body-wrapper">
            ...
            <div class="page-sidebar">
                <div class="main-header-left d-none d-lg-block">
                    <div class="logo-wrapper"><a href="{{ url('admin/dashboard') }}"><img
                                src="{{ asset('logo-removebg-preview.png') }}" style="width: 200px;"
                                alt=""></a>
                    </div>
                </div>
                    ...
                    @if ($user_session->is_super_admin == 1)
                        <ul class="sidebar-menu">
                            <li><a class="sidebar-header" href="{{ url('admin/dashboard') }}"><i
                                        data-feather="home"></i><span>{{ trans('dashboard') }}</span></a>
                            ...
                            <li><a class="sidebar-header" href="#"><i
                                        data-feather="settings"></i><span>{{ __('settings') }}</span><i
                                        class="fa fa-angle-right pull-right"></i></a>
                                <ul class="sidebar-submenu">
                                    <li><a href="{{ url('admin/country') }}"><i class="fa fa-circle"></i> country</a>
                                    </li>
                                    ...
                                    <li><a href="{{ url('admin/payment_gateway') }}"><i
                                                class="fa fa-circle"></i>Payment Gateway</a></li>
                                    <li><a href="{{ url('admin/social_lite_login') }}"><i
                                                class="fa fa-circle"></i>Socialite Login</a></li>
                                    <li><a href="{{ url('admin/website_setting') }}"><i
                                                class="fa fa-circle"></i>General Seting</a></li>
                                </ul>
                            </li>
                            ...
                            <li><a class="sidebar-header" href="#"><i
                                        data-feather="shopping-bag"></i><span>Payment Management</span><i
                                        class="fa fa-angle-right pull-right"></i></a>
                                <ul class="sidebar-submenu">
                                    <li><a href="{{ url('admin/qrcode') }}"><i class="fa fa-circle"></i> Manual
                                            Payment Method</a></li>
                                    <li><a href="{{ url('admin/credit_reload') }}"><i class="fa fa-circle"></i>
                                            Credit Reload</a></li>
                                    <li><a href="{{ url('admin/subscription/payment_reports') }}"><i
                                                class="fa fa-circle"></i> Payment Report </a></li>
                                </ul>
                            </li>

                            <li><a class="sidebar-header" href="{{ url('admin/credit_reload_promotions') }}"><i
                                        data-feather="book"></i><span>Credits</span></a> </li>
                        ...
                        <li><a class="sidebar-header" href="#"><i data-feather="home"></i><span>Permission
                            ...
                            <li><a class="sidebar-header" href="#"><i data-feather="shopping-bag"></i><span>Ads
                                        Management</span><i class="fa fa-angle-right pull-right"></i></a>
                                <ul class="sidebar-submenu">
                                    <li><a href="categories"><i class="fa fa-circle"></i> Service</a></li>
                                    <li><a href="{{ url('admin/Course_list') }}"><i class="fa fa-circle"></i>Category
                                            List</a></li>
                    ...
                    @if ($user_session->is_super_admin == 0 and $user_session->account_type == 'admin')
                        <ul class="sidebar-menu">
                            <li><a class="sidebar-header" href="{{ url('admin/banners') }}"><i
                                        data-feather="book"></i><span>Banner</span></a></li>
                            <li><a class="sidebar-header" href="{{ url('admin/ads_list') }}"><i
                                        data-feather="book"></i><span> Ads</span></a></li>
                            <li><a class="sidebar-header" href="{{ url('admin/users') }}"><i
                                        data-feather="users"></i><span>User Management</span></a></li>
                            <li><a class="sidebar-header" href="{{ url('admin/credit_reload') }}"><i
                                        data-feather="book"></i> Credit Reload</a></li>
                            <li><a class="sidebar-header" href="{{ url('admin/balance') }}"><i
                                        data-feather="dollar-sign"></i><span>Balance </span></a></li>
                        </ul>
                    @endif
    ...
    <script src="https://cdn.tiny.cloud/1/pzdns3vajz53swqokshw2lkh5xs5wlh77npc2iztvc5c1u0d/tinymce/6/tinymce.min.js"
