                          ...
                          <div class="tab-pane fade" id="pills-darkhome" role="tabpanel" aria-labelledby="pills-darkhome-tab">
                            <div class="email-compose">
                              ...
                              <div class="email-wrapper">
                                <form class="theme-form" action="{{url('admin/sendMessage')}}" method="post">
                                    @csrf
                                  <div class="mb-3">
                                  ...
                                  <div class="mb-3">
                                    ...
                                    <input class="form-control" name="subject" id="exampleInputPassword1" type="text">
                                  </div>
                                  <div>
                                  ...
                                  <div class="col-sm-4 btn-middle xl-50">
                                    <button class="btn btn-primary btn-block btn-mail text-center mb-0 mt-0 w-100" type="submit"><i class="fa fa-paper-plane me-2"></i> SEND</button>
                                  </div>
                                </form>
                              </div>
                            </div>
