...
<section id="section">
    <article class="Purchase Purchasefont">
        ...
        <div class="Purchasebg">
            ...
            @else
            <img src="{{asset('images/1.5.png')}}" alt="bg">
            @endif
                ...
                <div class="table-responsive-md">
                    <table class="table caption-top">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th scope="row">Add First Model</th>
                                <td>
                                    <select class="form-select form-select-md w-75 first_col" name="bfirstmodel" onchange="calculateTotal('total1')" aria-label="Large select example">
                                ...
                                <td>
                                    <select class="form-select form-select-md w-75 fifth_col" name="sfirstmodel" onchange="calculateTotal2('total2')" aria-label="Large select example">
                                        <option value="0" id="t_1" selected="">Select Model</option>
                                        <option value="60" id="t_1">Time Series (60 $)</option>
                                        <option value="80" id="t_1">Machine Learning (80 $)</option>
                                        <option value="100" id="t_1">Deep Learning (100 $)</option>
                                ...
                                <td>
                                    <select class="form-select form-select-md w-75 ninth_col" name="pfirstmodel"  onchange="calculateTotal3('total3')" aria-label="Large select example">
                                        <option value="0" id="t_1" selected="">Select Model</option>
                                        <option value="60" id="t_1">Time Series (60 $)</option>
                                        <option value="80" id="t_1">Machine Learning (80 $)</option>
                                        <option value="100" id="t_1">Deep Learning (100 $)</option>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select class="form-select form-select-md w-75 second_col" name="bsecondmodel" onchange="calculateTotal('total1')" aria-label="Large select example">
                                        <option value="0" id="t_1" selected="">Select Model</option>
                                ...
                                <td>
                                    <select class="form-select form-select-md w-75 six_col" name="ssecondmodel" onchange="calculateTotal2('total2')" aria-label="Large select example">
                                        <option value="0" id="t_1" selected="">Select Model</option>
                                        <option value="60">Time Series (60 $)</option>
                                        <option value="80">Machine Learning (80 $)</option>
                                        <option value="100">Deep Learning (100 $)</option>
                                ...
                                <td>
                                    <select class="form-select form-select-md w-75 tenth_col" name="psecondmodel" onchange="calculateTotal3('total3')" aria-label="Large select example">
                                        <option value="0" id="t_1" selected="">Select Model</option>
                                        <option value="60" id="t_1">Time Series (60 )</option>
                                        <option value="80" id="t_1">Machine Learning (80 )</option>
                                        <option value="100" id="t_1">Deep Learning (100 )</option>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select class="form-select form-select-md w-75 third_col" name="bthirdmodel" onchange="calculateTotal('total1')" aria-label="Large select example">
                                        <option value="0" id="t_1" selected="">Select Model</option>
                                        <option value="60">Time Series (60 $)</option>
                                        <option value="80">Machine Learning (80 $)</option>
                                        <option value="100">Deep Learning (100 $)</option>
                                ...
                                <td>
                                    <select class="form-select form-select-md w-75 seven_col" name="sthirdmodel" onchange="calculateTotal2('total2')" aria-label="Large select example">
                                        <option value="0" id="t_1" selected="">Select Model</option>
                                        <option value="60">Time Series (60 $)</option>
                                        <option value="80">Machine Learning (80 $)</option>
                                        <option value="100">Deep Learning (100 $)</option>
                                ...
                                <td>
                                    <select class="form-select form-select-md w-75 elevant_col" ame="pthirdmodel" onchange="calculateTotal3('total3')" aria-label="Large select example">
                                        <option value="0" id="t_1" selected="">Select Model</option>
                                        <option value="60" id="t_1">Time Series (60 )</option>
                                        <option value="80" id="t_1">Machine Learning (80 )</option>
                                        <option value="100" id="t_1">Deep Learning (100 )</option>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select class="form-select form-select-md w-75 fourth_col" name="bdashboard" onchange="calculateTotal('total1')" aria-label="Large select example">
                                ...
                                <td>
                                    <select class="form-select form-select-md w-75 eight_col" name="sdashboard" onchange="calculateTotal2('total2')" aria-label="Large select example">
                                        <option value="0" id="t_1" selected="">Select Dashboard</option>
                                        <option value="50">Excel Basic (50$)</option>
                                        <option value="100">Excel Standard (100 $)</option>
                                        <option value="200">Excel Premium (200 $)</option>
                                ...
                                <td>
                                    <select class="form-select form-select-md w-75 twowelve_col" name="pdashboard" onchange="calculateTotal3('total3')" aria-label="Large select example">
                                        <option value="0" id="t_1" selected="">Select Dashboard</option>
                                        <option value="50">Excel Basic (50$)</option>
                                        <option value="100">Excel Standard (100 $)</option>
                                        <option value="200">Excel Premium (200 $)</option>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="submit" class="btn button" onclick="setValueAndSubmit('100')" > Continue <input type="text" readonly placeholder="100" class="transparent-input" name="bamount" id="total1" value="">$</button>
                                </td>
                                <td>
...
// Set the input value to a hidden input field in the form
        document.getElementById('selected_value').value = inputValue;
            ...
            function calculateTotal(totalId) {
                ...
                if (!isNaN(firstValue) && !isNaN(secondValue) && !isNaN(thirdValue) && !isNaN(fourthValue)) {
                    var total = firstValue + secondValue + thirdValue + fourthValue + 100;
            ...
            function calculateTotal2(totalId) {
                ...
                var sixValue = parseFloat(document.querySelector('.six_col').value);
                var sevenValue = parseFloat(document.querySelector('.seven_col').value);
                var eightValue = parseFloat(document.querySelector('.eight_col').value);

                // Check if values are valid numbers
                if (!isNaN(fifthValue) && !isNaN(sixValue) && !isNaN(sevenValue) && !isNaN(eightValue)) {
                    var total = fifthValue + sixValue + sevenValue + eightValue + 140;
            ...
            function calculateTotal3(totalId) {
                ...
                var tenthValue = parseInt(document.querySelector('.tenth_col').value);
                var elevantValue = parseFloat(document.querySelector('.elevant_col').value);
                var twowelveValue = parseFloat(document.querySelector('.twowelve_col').value);


                // Check if values are valid numbers
                if (!isNaN(ninthValue) && !isNaN(tenthValue) && !isNaN(elevantValue) && !isNaN(twowelveValue)) {
                    var total = ninthValue + tenthValue + elevantValue + twowelveValue + 200;
                        ...
                        <div class="row row-1">
                            ...
                            <div class="content_wrapper text-center">
                                <ul class="features">
                                    ...
                                    <li class="mt-3"><i class="fas fa-check"></i><span style="font-size: 15px;">Add First
                                            Model</span>
                                    </li>
                                    <select class="form-select form-select-md  ten_col"  name="mbfirst" onchange="McalculateTotal('total4')" aria-label="Large select example">
                                        <option value="0" id="t_1" selected="">Select Model</option>
                                        <option value="60" id="t_1">Time Series (60 $)</option>
                                        <option value="80" id="t_1">Machine Learning (80 $)</option>
                                        <option value="100" id="t_1">Deep Learning (100 $)</option>
                                    ...
                                    <select class="form-select form-select-md  eleven_col"  name="mbsecond" onchange="McalculateTotal('total4')" aria-label="Large select example">
                                        <option value="0" id="t_1" selected="">Select Model</option>
                                        <option value="60">Time Series (60 $)</option>
                                        <option value="80">Machine Learning (80 $)</option>
                                        <option value="100">Deep Learning (100 $)</option>
                                    ...
                                    <select class="form-select form-select-md  meleven_col" name="mbthird" onchange="McalculateTotal('total4')" aria-label="Large select example">
                                        <option value="0" id="t_1" selected="">Select Model</option>
                                        <option value="60">Time Series (60 $)</option>
                                        <option value="80">Machine Learning (80 $)</option>
                                        <option value="100">Deep Learning (100 $)</option>
                                ...
                                <button type="submit" class="btn button" onclick="MsetValueAndSubmit('100')"> Continue <input type="text" readonly placeholder="100" class="transparent-input" name="mbamount" id="total4" value="">$</button>
                        ...
                        <div class="row">
                            ...
                            <div class="content_wrapper text-center">
                                <ul class="features">
                                    ...
                                    <select class="form-select form-select-md  thirdteen_col" name="msfirst" onchange="McalculateTotal2('total5')" aria-label="Large select example">
                                        <option value="0" id="t_1" selected="">Select Model</option>
                                        <option value="60" id="t_1">Time Series (60 $)</option>
                                        <option value="80" id="t_1">Machine Learning (80 $)</option>
                                        <option value="100" id="t_1">Deep Learning (100 $)</option>
                                    ...
                                    <select class="form-select form-select-md  fourtheen_col" name="mssecond" onchange="McalculateTotal2('total5')" aria-label="Large select example">
                                        <option value="0" id="t_1" selected="">Select Model</option>
                                        <option value="60">Time Series (60 $)</option>
                                        <option value="80">Machine Learning (80 $)</option>
                                        <option value="100">Deep Learning (100 $)</option>
                                    ...
                                    <select class="form-select form-select-md  mfourtheen_col" name="msthird" onchange="McalculateTotal2('total5')" aria-label="Large select example">
                                        <option value="0" id="t_1" selected="">Select Model</option>
                                        <option value="60">Time Series (60 $)</option>
                                        <option value="80">Machine Learning (80 $)</option>
                                        <option value="100">Deep Learning (100 $)</option>
                        ...
                        <div class="row">
                            ...
                            <div class="content_wrapper text-center">
                                <ul class="features">
                                    ...
                                    <select class="form-select form-select-md  mt-2 mb-2 seventheen_col" name="mpfirst" aria-label="Large select example" onchange="McalculateTotal3('total6');" aria-label="Large select example">
                                        <option value="0" id="t_1" selected="">Select Model</option>
                                        <option value="60">Time Series (60 $)</option>
                                        <option value="80">Machine Learning (80 $)</option>
                                        <option value="100">Deep Learning (100 $)</option>
                                    ...
                                    <select class="form-select form-select-md  mt-2 mb-2 eightheen_col" name="mpsecond" aria-label="Large select example" onchange="McalculateTotal3('total6');" aria-label="Large select example">
                                        <option value="0" id="t_1" selected="">Select Model</option>
                                        <option value="60">Time Series (60 $)</option>
                                        <option value="80">Machine Learning (80 $)</option>
                                        <option value="100">Deep Learning (100 $)</option>
                                    ...
                                    <select class="form-select form-select-md  mt-2 mb-2 meightheen_col" name="mpthird" aria-label="Large select example" onchange="McalculateTotal3('total6');" aria-label="Large select example">
                                        <option value="0" id="t_1" selected="">Select Model</option>
                                        <option value="60">Time Series (60 $)</option>
                                        <option value="80">Machine Learning (80 $)</option>
                                        <option value="100">Deep Learning (100 $)</option>
...
// Set the input value to a hidden input field in the form
        ...
        function McalculateTotal(totalId) {
            ...
            var thirdValue = parseFloat(document.querySelector('.meleven_col').value);
            var fourthValue = parseFloat(document.querySelector('.twelve_col').value);
            // Check if values are valid numbers
            if (!isNaN(firstValue) && !isNaN(secondValue) && !isNaN(thirdValue) && !isNaN(fourthValue)) {
                var total = firstValue + secondValue + thirdValue + fourthValue + 100;
        ...
        function McalculateTotal2(totalId) {
            ...
            var sixthValue = parseFloat(document.querySelector('.mfourtheen_col').value);
            var sevenValue = parseFloat(document.querySelector('.fifteen_col').value);
            // Check if values are valid numbers
            if (!isNaN(fourthValue) && !isNaN(fifthValue) && !isNaN(sixthValue) && !isNaN(sevenValue)) {
                var total = fourthValue + fifthValue + sixthValue + sevenValue + 140;
        ...
        function McalculateTotal3(totalId) {
            ...
            var ninthValue = parseFloat(document.querySelector('.meightheen_col').value);
            var Value = parseFloat(document.querySelector('.nintheen_col').value);
            // Check if values are valid numbers
            if (!isNaN(seventhValue) && !isNaN(eighthValue) && !isNaN(ninthValue) && !isNaN(Value)) {
                var total = seventhValue + eighthValue + ninthValue + Value +200;
    ...
    <article>
        <div class="columns-info section2">
            <ul class="info">
                ...
                <li><span><i class="fa-solid fa-star" style="color: #EDB954;"></i></span><span><i class="fa-solid fa-star" style="color: #EDB954;"></i></span><span><i class="fa-solid fa-star" style="color: #EDB954;"></i></span> xclude weekend days.</li>
            </ul>
        </div>
    </article>
        ...
        <div class="questions">
            <details class="details">
                <summary class="summary">
                    How do you handle Models not working on the python environment of the project?
                </summary>
                <p>
