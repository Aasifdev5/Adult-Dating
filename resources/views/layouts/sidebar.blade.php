    ...
    <nav class="sidebar-nav">
        <div class="d-flex align-items-center justify-content-between mb-3 overflow-hidden sidebar-inner-header">
            <a class="navbar-brand d-flex align-items-center" href="{{url('/')}}">
                <img class="navbar-brand-minimized me-4" src="{{ getThumbLogoUrl() }}" width="200" alt="Sky Forecasting Logo"
                     height="50" alt="{{config('app.name')}}">
                <span class="d-flex">
                    <!-- <span class="brand-name-infy">Sky Forecasting</span><span class="brand-name-chat"></span> -->
                </span>
            </a>
