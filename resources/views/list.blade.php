    ...
    <div class="container">
        <ol itemscope="itemscope" itemtype="http://schema.org/BreadcrumbList" id="bc1" class="btn-group btn-breadcrumb list-inline">
            ...
            <li itemprop="itemListElement" itemscope="itemscope" class="list-bcseo">
                <a itemscope="itemscope" itemid="massages/" itemtype="http://schema.org/Service" itemprop="item" href="{{url('ads_list/')}}/<?php echo $lcategory; ?>" class="btn btn-outline-primary ">
                    <div itemprop="name">{{$lcategory}}</div>
                </a>
