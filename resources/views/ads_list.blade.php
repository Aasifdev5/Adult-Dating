...
@section('content')
                            ...
                            <form id="vue-search" action="{{ url('search') }}" method="get">
                                ...
                                <div class="form-row">
                                    <div class="col-sm-12 col-12 form-group">
                                        <input type="text" name="keyword" autocomplete="off" id="search-input"
    ...
    <nav class="breadcrumb">
        <div class="container">
            <ol itemscope="itemscope" itemtype="http://schema.org/BreadcrumbList" id="bc1"
                class="btn-group btn-breadcrumb list-inline">
                <li itemprop="itemListElement" itemscope="itemscope">
                    <a itemscope="itemscope" itemid="" itemtype="http://schema.org/Service" itemprop="item"
                ...
                <li itemprop="itemListElement" itemscope="itemscope" class="list-bcseo">
                    <a itemscope="itemscope" itemid="massages/" itemtype="http://schema.org/Service" itemprop="item"
                        href="{{ url('ads_list/') }}/<?php echo $id; ?>" class="btn btn-outline-primary ">
                    ...
                    <div id="outer">
                        <div id="inner">
                            @foreach ($story as $index => $row)
                                @php
                                    $tadsPhoto = App\Models\Image::where('user_id', $row->user_id)
                                ...
                                <div class="stories_thumb">
                                    ...
                                    <a href="#" id="storyThumbLink{{ $index }}" data-toggle="modal"
                                ...
                                <!-- Story Modal -->
                                <div class="modal fade" id="storyModal{{ $index }}" tabindex="-1"
                                    role="dialog" aria-labelledby="storyModalLabel{{ $index }}"
                                    aria-hidden="true">
                                    <div class="modal-dialog modal-lg modal-dialog-centered">
                                        <div class="modal-content bg-dark">
                                            <div class="modal-header border-0">
                                                <a href="{{ url('ad_details/') }}<?php echo '/' . $row->ad_id; ?>" target="_self">
                                                    <h5 class="modal-title text-title cursor-pointer onlydk">
                                                        {{ $row->title }} <div class="tagcard">
                                                </a>
                                        ...
                                        <div class="modal-body">
                                            <div id="storiesModalCarousel" data-interval="5000" data-ride="carousel"
                                                class="carousel slide">
                                                <ol class="carousel-indicators stories">
                                                    @php
                                                        $tadsPhotos = App\Models\Image::where('user_id', $row->user_id)
                                                            ->where('ad_id', $row->ad_id)
                                                            ->get();
                                                    @endphp

                                                    @foreach ($tadsPhotos as $index => $topadsPhoto)
                                                        <li data-target="#storiesModalCarousel"
                                                            data-slide-to="{{ $index }}"
                                                ...
                                                <a role="button" class="carousel-control-prev"
                                                    href="#storiesModalCarousel" role="button" data-slide="prev">
                                                    <span aria-hidden="true" class="carousel-control-prev-icon"></span>
                                                    <span class="sr-only">Previous</span>
                                                </a>

                                                <a role="button" class="carousel-control-next"
                                                    href="#storiesModalCarousel" role="button" data-slide="next">
                ...
                <div class="item-card bordersupertop">
                    <div id="carousel-6560352dbe400c828c5ac2ae" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            @php
                                $adsPhotos = App\Models\Image::where('user_id', $row->user_id)
                                    ->where('ad_id', $row->id)
                                    ->get();
                            @endphp
                        ...
                        <a href="#carousel-6560352dbe400c828c5ac2ae" role="button" data-slide="prev" title="Previous"
                            class="carousel-control-prev slide-action">
                            <span aria-hidden="true" class="carousel-control-prev-icon slide-action"></span>
                            <span class="sr-only">Previous</span>
                        </a>
                        <a href="#carousel-6560352dbe400c828c5ac2ae" role="button" data-slide="next" title="Next"
                            class="carousel-control-next slide-action">
                    ...
                    <div class="item-container ">
                        <div class="item-card-container">
                            <div class="item-content">
                                <div class="item-heading">
                                    <p class="item-title">
                                        <a href="{{ url('ad_details/') }}<?php echo '/' . $row->id; ?>" target="_self"
                                            data-pck="272144"> {{ $row->title }} </a>
                                    </p>
                                </div>
                                ...
                                <div class="tagcard">
                                    ...
                                    @foreach (explode(',', $row->search_tag__services) as $service)
                                        <span class="badge-pill special-tag">
                                            <i aria-hidden="true" class="fa fa-star-o mr-1"></i>
                                            {{ str_replace('_', ' ', $service) }} </span>
                                    @endforeach
                        ...
                        <div class="item-card-contact ga-list-premium-contact-buttons ">
                            ...
                            <a target="_blank" rel="nofollow" href="https://wa.me/"
                                class="btn btn-lg btn-outline btn-circle">
